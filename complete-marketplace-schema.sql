-- Complete Waste Removal Marketplace Schema
-- Run this entire script in Supabase SQL Editor

-- First, create the brands table (referenced by all other tables)
...
-- Insert Wefixico brand
INSERT INTO brands (brand_id, brand_name, brand_slug, is_active) 
VALUES ('wefixico-brand-id', 'Wefixico', 'wefixico', true)
...
CREATE INDEX IF NOT EXISTS idx_quotes_brand ON quotes(brand_id);
CREATE INDEX IF NOT EXISTS idx_quotes_phone ON quotes(customer_phone);
CREATE INDEX IF NOT EXISTS idx_quotes_status ON quotes(status);
CREATE INDEX IF NOT EXISTS idx_quotes_created ON quotes(created_at);
CREATE INDEX IF NOT EXISTS idx_quotes_booking_ref ON quotes(booking_reference);

-- Partners table (waste removal service providers) - CREATE BEFORE JOBS
...
CREATE INDEX IF NOT EXISTS idx_jobs_reference ON jobs(job_reference);
...
CREATE INDEX IF NOT EXISTS idx_job_bids_brand ON job_bids(brand_id);
CREATE INDEX IF NOT EXISTS idx_job_bids_job ON job_bids(job_id);
CREATE INDEX IF NOT EXISTS idx_job_bids_partner ON job_bids(partner_id);
